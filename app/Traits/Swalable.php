...
trait Swalable {
    public function flashSuccess($message, $footer = null, $redirect = null) {
        $this->setupFlash("Sukses", $message, 'success', $footer, $redirect);
    }
    ...
    public function toastError($title) {
        $this->setupToast('error', $title);
    }

    private function setupFlash($title, $message, $type, $footer = null, $redirect = null) {
